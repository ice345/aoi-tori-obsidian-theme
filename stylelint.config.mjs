export default {
  ...
  rules: {
    ...
    "custom-property-pattern":
      "^(aoi|anim|background|bases|blockquote|bold|button|callout|canvas|caret|checkbox|checklist|clickable|code|color|embed|file|font|graph|h[1-6]|header|hr|icon|image|indentation|input|interactive|italic|line|link|list|menu|metadata|modal|nav|pdf|radius|ribbon|search|setting|shadow|size|status|tab|table|tag|text|titlebar)-[a-z0-9-]+$",
