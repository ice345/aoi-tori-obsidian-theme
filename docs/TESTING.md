...
| Density and touch geometry (G08)                                  | In `npm run check`                | `--input-height` resolves to 32 / 34 / 38px across the three densities, and the three themed touch containers hold 44px on a phone. Setting Compact back to 34px reports `--input-height is 34px, expected 32px`; dropping a container to 40px reports it against the 44px project target                                                                                              |
